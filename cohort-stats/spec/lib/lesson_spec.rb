...
describe Lesson do
  describe ".new" do
    it "takes a name and body as arguments" do
      student = Lesson.new("Lesson1", "You will learn a lot from this lesson")
      expect(student).to be_a(Lesson)
    end
  end

  let(:lesson) { Lesson.new("Lesson1", "You will learn a lot from this lesson") }
